...
const BenefitsSection = () => {
  return (
    <div className="bg-slate-900 text-white py-16 px-4 md:px-12 lg:px-24">
      <div className="text-center mb-12">
      <div className="mt-4 sm:mt-4 mb-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#start-trial"
              className="bg-slate-900 text-cyan-400  px-12 py-2 rounded-full border border-gray-400 shadow hover:shadow-lg hover:bg-blue-50 transition "
            >
              Benefits
            </a>
            </div>
        <h2 className="text-3xl md:text-4xl font-bold">
          Unlock the advantages of using Recruito AI
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="p-6 bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-semibold mb-2 text-center">Automate Processes</h3>
        ...
        <div className="p-6 bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-semibold mb-2 text-center">Provide Instant Information</h3>
          <p className="text-center text-gray-400">
        ...
        <div className="p-6 bg-slate-800 rounded-lg shadow-md hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-semibold mb-2 text-center">Make Data-Driven Decisions</h3>
          <p className="text-center text-gray-400">
